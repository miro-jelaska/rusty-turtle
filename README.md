...
There is, however, a fair bit of Sass in [index.scss](styles/index.scss) you can remove.
...
There are two empty spaces in the MIT license you need to fill out: `` and `miro`.
